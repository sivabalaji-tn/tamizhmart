...
--
-- Host: mysql:3306
-- Generation Time: Sep 21, 2026 at 05:32 PM
...
(190, 1, 1, 11, 1, '2026-09-20 15:52:20');
...
(3, 1, 10, 6000.00, 1, 120.00, 2.00, '2026-08-23 00:00:00', '2026-08-23 12:13:36', 1, '', '2026-08-23 12:13:36'),
(4, 1, 12, 559.00, 1, 11.18, 2.00, '2026-08-23 00:00:00', '2026-09-12 10:30:10', 1, '', '2026-09-12 10:30:10');
...
(3, 1, 43, 6000.00, 2.00, 120.00, 1, '2026-08-23 12:13:36', '2026-08-23 12:11:54'),
(4, 1, 44, 559.00, 2.00, 11.18, 1, '2026-09-12 10:30:10', '2026-09-01 13:50:06'),
(5, 1, 45, 1171.00, 2.00, 23.42, 0, NULL, '2026-09-16 18:55:18'),
(6, 1, 46, 179.00, 2.00, 3.58, 0, NULL, '2026-09-17 05:21:09'),
(7, 1, 47, 250.00, 2.00, 5.00, 0, NULL, '2026-09-19 17:22:40'),
(8, 1, 48, 225.00, 2.00, 4.50, 0, NULL, '2026-09-19 17:58:11'),
(9, 1, 49, 250.00, 2.00, 5.00, 0, NULL, '2026-09-19 18:25:00');
...
INSERT INTO `coupons` (`id`, `shop_id`, `code`, `type`, `value`, `min_order`, `max_uses`, `used_count`, `expires_at`, `is_active`, `created_at`) VALUES
(1, 1, 'WELCOME20', 'percent', 10.00, 250.00, 25, 0, '2026-09-02', 1, '2026-09-01 13:40:42');
...
--
-- Dumping data for table `delivery_otps`
--

INSERT INTO `delivery_otps` (`id`, `order_id`, `handler_id`, `otp_code`, `sent_at`, `expires_at`, `verified_at`) VALUES
(1, 45, 1, '352949', '2026-09-17 05:32:52', '2026-09-17 05:47:52', '2026-09-17 05:35:25'),
(4, 44, 1, '261995', '2026-09-17 05:37:17', '2026-09-17 05:52:17', '2026-09-17 05:37:47'),
(5, 34, 1, '259028', '2026-09-17 05:22:05', '2026-09-17 05:37:05', '2026-09-17 05:32:07'),
(7, 46, 1, '394266', '2026-09-17 05:36:13', '2026-09-17 05:51:13', '2026-09-17 05:36:34'),
(9, 40, 1, '440633', '2026-09-17 05:38:30', '2026-09-17 05:53:30', '2026-09-17 05:38:52'),
(10, 47, 1, '883960', '2026-09-19 17:24:17', '2026-09-19 17:39:17', '2026-09-19 17:25:00'),
(11, 48, 1, '627239', '2026-09-19 18:28:09', '2026-09-19 18:43:09', '2026-09-19 18:29:10'),
(23, 49, 1, '250256', '2026-09-19 18:29:38', '2026-09-19 18:44:38', '2026-09-19 18:29:50');
...
INSERT INTO `email_campaigns` (`id`, `shop_id`, `owner_id`, `month_key`, `preset`, `campaign_type`, `audience_type`, `subject`, `headline`, `description`, `offer_text`, `coupon_code`, `cta_label`, `status`, `recipient_count`, `sent_count`, `failed_count`, `created_at`, `sent_at`) VALUES
(1, 1, 1, '2026-09', 'customer_reward', 'announcement', 'all_registered', 'About the New Offers', 'We proud being in your service', 'Purchasing single product can have the free Delivery', 'Free Delivery for order Above 1 Rupees', 'SAVE10', 'Shop Now', 'sent', 9, 9, 0, '2026-09-05 18:34:06', '2026-09-05 18:35:06'),
(2, 1, 1, '2026-09', 'festival_offer', 'coupon', 'all_registered', 'Ayudha Pooja Speical Offer', 'Ayudha Pooja Special Offer for Customers', 'Buy more than 1000 and get more rewards', 'Offers for Customers', 'FESTIVAL2026', 'Shop Now', 'failed', 9, 0, 9, '2026-09-18 09:20:55', '2026-09-18 09:23:09');

-- --------------------------------------------------------

--
-- Table structure for table `email_campaign_allowances`
--

CREATE TABLE `email_campaign_allowances` (
  `id` int(10) UNSIGNED NOT NULL,
  `shop_id` int(10) UNSIGNED NOT NULL,
  `month_key` char(7) NOT NULL,
  `monthly_limit` int(10) UNSIGNED NOT NULL DEFAULT 2,
...
--
-- Dumping data for table `email_campaign_allowances`
--

INSERT INTO `email_campaign_allowances` (`id`, `shop_id`, `month_key`, `monthly_limit`, `used_count`, `reset_count`, `reset_by`, `reset_at`, `created_at`, `updated_at`) VALUES
(1, 1, '2026-09', 25, 1, 3, 1, '2026-09-12 09:41:57', '2026-09-05 18:24:48', '2026-09-18 09:23:09'),
(4, 4, '2026-09', 2, 0, 0, NULL, NULL, '2026-09-05 18:24:50', '2026-09-05 18:24:50'),
(5, 5, '2026-09', 2, 0, 0, NULL, NULL, '2026-09-05 18:24:50', '2026-09-05 18:24:50'),
(6, 6, '2026-09', 2, 0, 0, NULL, NULL, '2026-09-05 18:24:50', '2026-09-05 18:24:50'),
(7, 9, '2026-09', 2, 0, 0, NULL, NULL, '2026-09-05 18:24:50', '2026-09-05 18:24:50'),
(8, 10, '2026-09', 2, 0, 0, NULL, NULL, '2026-09-05 18:24:50', '2026-09-05 18:24:50');

-- --------------------------------------------------------

--
-- Table structure for table `email_campaign_products`
--
...
--
-- Dumping data for table `email_campaign_products`
--

INSERT INTO `email_campaign_products` (`id`, `campaign_id`, `product_id`) VALUES
(1, 1, 16),
(2, 1, 13),
(3, 2, 83),
(4, 2, 13),
...
INSERT INTO `email_campaign_recipients` (`id`, `campaign_id`, `user_id`, `email`, `status`, `sent_at`, `error_message`) VALUES
(1, 1, 1, 'sivabalaji800@gmail.com', 'sent', '2026-09-05 18:34:14', NULL),
(2, 1, 2, 'sharmamedhini1975@gmail.com', 'sent', '2026-09-05 18:34:20', NULL),
(3, 1, 4, 'rsasi5972@gmail.com', 'sent', '2026-09-05 18:34:27', NULL),
(4, 1, 7, 'sivabalaji2335@gmail.com', 'sent', '2026-09-05 18:34:33', NULL),
(5, 1, 8, 'sivathetechie24@gmail.com', 'sent', '2026-09-05 18:34:39', NULL),
(6, 1, 9, 'sivabalaji607@gmail.com', 'sent', '2026-09-05 18:34:45', NULL),
(7, 1, 10, 'sivabalaji709@gmail.com', 'sent', '2026-09-05 18:34:54', NULL),
(8, 1, 11, 'sivabalaji381@gmail.com', 'sent', '2026-09-05 18:35:00', NULL),
(9, 1, 12, 'tamizhmartnotify@gmail.com', 'sent', '2026-09-05 18:35:06', NULL),
(10, 2, 1, 'sivabalaji800@gmail.com', 'failed', NULL, 'SMTP send failed'),
(11, 2, 2, 'sharmamedhini1975@gmail.com', 'failed', NULL, 'SMTP send failed'),
(12, 2, 4, 'rsasi5972@gmail.com', 'failed', NULL, 'SMTP send failed'),
(13, 2, 7, 'sivabalaji2335@gmail.com', 'failed', NULL, 'SMTP send failed'),
(14, 2, 8, 'sivathetechie24@gmail.com', 'failed', NULL, 'SMTP send failed'),
(15, 2, 9, 'sivabalaji607@gmail.com', 'failed', NULL, 'SMTP send failed'),
(16, 2, 10, 'sivabalaji709@gmail.com', 'failed', NULL, 'SMTP send failed'),
(17, 2, 11, 'sivabalaji381@gmail.com', 'failed', NULL, 'SMTP send failed'),
(18, 2, 12, 'tamizhmartnotify@gmail.com', 'failed', NULL, 'SMTP send failed');

-- --------------------------------------------------------

--
-- Table structure for table `handler_activity_log`
--

CREATE TABLE `handler_activity_log` (
  `id` int(10) UNSIGNED NOT NULL,
  `handler_id` int(10) UNSIGNED NOT NULL,
  `shop_id` int(10) UNSIGNED NOT NULL,
  `order_id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `handler_activity_log`
--

INSERT INTO `handler_activity_log` (`id`, `handler_id`, `shop_id`, `order_id`, `action`, `old_value`, `new_value`, `note`, `created_at`) VALUES
(1, 1, 1, 45, 'status_update', 'confirmed', 'processing', NULL, '2026-09-16 18:58:28'),
(2, 1, 1, 45, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-16 18:58:31'),
(3, 1, 1, 45, 'otp_sent', NULL, '490655', 'OTP sent to sivabalaji800@gmail.com', '2026-09-16 18:58:38'),
(4, 1, 1, 45, 'otp_sent', NULL, '840992', 'OTP sent to sivabalaji800@gmail.com', '2026-09-16 18:59:53'),
(5, 1, 1, 44, 'status_update', 'pending', 'confirmed', NULL, '2026-09-16 19:01:02'),
(6, 1, 1, 44, 'status_update', 'confirmed', 'processing', NULL, '2026-09-16 19:01:06'),
(7, 1, 1, 44, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-16 19:01:08'),
(8, 1, 1, 44, 'status_update', 'pending', 'confirmed', NULL, '2026-09-16 19:01:56'),
(9, 1, 1, 44, 'status_update', 'confirmed', 'processing', NULL, '2026-09-16 19:02:03'),
(10, 1, 1, 44, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-16 19:02:05'),
(11, 1, 1, 45, 'otp_sent', NULL, '429808', 'OTP sent to sivabalaji800@gmail.com', '2026-09-16 19:04:01'),
(12, 1, 1, 45, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-16 19:04:35'),
(13, 1, 1, 45, 'cod_collected', NULL, '1171', 'COD collected: ₹1,171.00', '2026-09-16 19:04:35'),
(14, 1, 1, 44, 'otp_sent', NULL, '372562', 'OTP sent to sivabalaji800@gmail.com', '2026-09-16 19:04:50'),
(15, 1, 1, 44, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-16 19:05:29'),
(16, 1, 1, 34, 'status_update', 'pending', 'confirmed', NULL, '2026-09-17 05:21:38'),
(17, 1, 1, 34, 'status_update', 'confirmed', 'processing', NULL, '2026-09-17 05:21:44'),
(18, 1, 1, 34, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-17 05:21:47'),
(19, 1, 1, 34, 'otp_sent', NULL, '259028', 'OTP sent to sivabalaji800@gmail.com', '2026-09-17 05:22:05'),
(20, 1, 1, 44, 'status_update', 'pending', 'confirmed', NULL, '2026-09-17 05:26:32'),
(21, 1, 1, 45, 'status_update', 'pending', 'confirmed', NULL, '2026-09-17 05:26:37'),
(22, 1, 1, 45, 'status_update', 'confirmed', 'processing', NULL, '2026-09-17 05:26:40'),
(23, 1, 1, 45, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-17 05:26:42'),
(24, 1, 1, 34, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-17 05:32:07'),
(25, 1, 1, 34, 'cod_collected', NULL, '539740', 'COD collected: ₹539,740.00', '2026-09-17 05:32:07'),
(26, 1, 1, 45, 'otp_sent', NULL, '352949', 'OTP sent to sivabalaji800@gmail.com', '2026-09-17 05:32:52'),
(27, 1, 1, 45, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-17 05:35:25'),
(28, 1, 1, 45, 'cod_collected', NULL, '1171', 'COD collected: ₹1,171.00', '2026-09-17 05:35:25'),
(29, 1, 1, 46, 'status_update', 'pending', 'confirmed', NULL, '2026-09-17 05:36:04'),
(30, 1, 1, 46, 'status_update', 'confirmed', 'processing', NULL, '2026-09-17 05:36:06'),
(31, 1, 1, 46, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-17 05:36:08'),
(32, 1, 1, 46, 'otp_sent', NULL, '394266', 'OTP sent to sivabalaji800@gmail.com', '2026-09-17 05:36:13'),
(33, 1, 1, 46, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-17 05:36:34'),
(34, 1, 1, 46, 'cod_collected', NULL, '179', 'COD collected: ₹179.00', '2026-09-17 05:36:34'),
(35, 1, 1, 44, 'status_update', 'confirmed', 'processing', NULL, '2026-09-17 05:36:47'),
(36, 1, 1, 44, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-17 05:37:03'),
(37, 1, 1, 44, 'otp_sent', NULL, '261995', 'OTP sent to sivabalaji800@gmail.com', '2026-09-17 05:37:17'),
(38, 1, 1, 44, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-17 05:37:47'),
(39, 1, 1, 40, 'status_update', 'pending', 'confirmed', NULL, '2026-09-17 05:38:06'),
(40, 1, 1, 40, 'status_update', 'confirmed', 'processing', NULL, '2026-09-17 05:38:13'),
(41, 1, 1, 40, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-17 05:38:17'),
(42, 1, 1, 40, 'otp_sent', NULL, '440633', 'OTP sent to sivabalaji800@gmail.com', '2026-09-17 05:38:30'),
(43, 1, 1, 40, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-17 05:38:52'),
(44, 1, 1, 40, 'cod_collected', NULL, '3121.51', 'COD collected: ₹3,121.51', '2026-09-17 05:38:52'),
(45, 1, 1, 47, 'status_update', 'confirmed', 'processing', NULL, '2026-09-19 17:24:11'),
(46, 1, 1, 47, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-19 17:24:13'),
(47, 1, 1, 47, 'otp_sent', NULL, '883960', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 17:24:17'),
(48, 1, 1, 47, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-19 17:25:00'),
(49, 1, 1, 48, 'status_update', 'confirmed', 'processing', NULL, '2026-09-19 18:01:10'),
(50, 1, 1, 48, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-19 18:01:13'),
(51, 1, 1, 48, 'otp_sent', NULL, '548390', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:01:16'),
(52, 1, 1, 48, 'otp_sent', NULL, '190175', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:02:52'),
(53, 1, 1, 48, 'otp_sent', NULL, '461241', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:04:49'),
(54, 1, 1, 48, 'otp_sent', NULL, '701737', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:06:03'),
(55, 1, 1, 48, 'otp_sent', NULL, '790565', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:12:21'),
(56, 1, 1, 48, 'otp_sent', NULL, '834892', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:12:50'),
(57, 1, 1, 48, 'otp_sent', NULL, '820561', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:17:51'),
(58, 1, 1, 48, 'status_update', 'pending', 'confirmed', NULL, '2026-09-19 18:20:56'),
(59, 1, 1, 48, 'status_update', 'confirmed', 'processing', NULL, '2026-09-19 18:20:58'),
(60, 1, 1, 48, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-19 18:21:00'),
(61, 1, 1, 48, 'otp_sent', NULL, '181177', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:21:04'),
(62, 1, 1, 48, 'otp_sent', NULL, '509341', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:23:17'),
(63, 1, 1, 48, 'otp_sent', NULL, '426007', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:23:33'),
(64, 1, 1, 48, 'otp_sent', NULL, '422261', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:24:40'),
(65, 1, 1, 48, 'otp_sent', NULL, '627239', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:28:09'),
(66, 1, 1, 48, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-19 18:29:10'),
(67, 1, 1, 49, 'status_update', 'confirmed', 'processing', NULL, '2026-09-19 18:29:32'),
(68, 1, 1, 49, 'status_update', 'processing', 'out_for_delivery', NULL, '2026-09-19 18:29:34'),
(69, 1, 1, 49, 'otp_sent', NULL, '250256', 'OTP sent to sivabalaji800@gmail.com', '2026-09-19 18:29:38'),
(70, 1, 1, 49, 'otp_verified', 'out_for_delivery', 'delivered', NULL, '2026-09-19 18:29:50');

-- --------------------------------------------------------

--
-- Table structure for table `handler_cod_settlements`
--

CREATE TABLE `handler_cod_settlements` (
  `id` int(10) UNSIGNED NOT NULL,
  `handler_id` int(10) UNSIGNED NOT NULL,
  `shop_id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `handler_cod_settlements`
--

INSERT INTO `handler_cod_settlements` (`id`, `handler_id`, `shop_id`, `amount`, `settled_by`, `note`, `settled_at`) VALUES
(1, 1, 1, 1171.00, 1, 'Collected at 17-09-2026/ 12:36 AM', '2026-09-16 19:06:47'),
(2, 1, 1, 544211.51, 1, '', '2026-09-17 05:39:36');
...
INSERT INTO `orders` (`id`, `shop_id`, `user_id`, `shop_order_number`, `total_amount`, `status`, `payment_method`, `payment_status`, `razorpay_order_id`, `razorpay_payment_id`, `address`, `notes`, `shipping_fee`, `discount_amount`, `coupon_code`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 490.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni Edamaal Street', '', 0.00, 0.00, NULL, '2026-07-18 06:55:08', '2026-07-25 06:43:16'),
(2, 1, 1, 2, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-07-18 06:55:41', '2026-07-25 06:44:22'),
(3, 1, 1, 3, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-07-18 07:08:16', '2026-07-25 06:44:15'),
(4, 1, 1, 4, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'MDU', '', 0.00, 0.00, NULL, '2026-07-18 07:20:21', '2026-07-25 06:44:11'),
(5, 1, 1, 5, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Gujarat', '', 0.00, 0.00, NULL, '2026-07-18 07:21:28', '2026-07-25 06:44:06'),
(6, 1, 1, 6, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Dindigul', '', 0.00, 0.00, NULL, '2026-07-18 07:24:59', '2026-07-25 06:44:01'),
(7, 1, 1, 7, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-07-18 07:30:54', '2026-07-25 06:43:55'),
(8, 1, 1, 8, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-07-18 07:39:02', '2026-07-25 06:43:44'),
(9, 1, 1, 9, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-07-18 07:43:36', '2026-07-25 06:43:36'),
(10, 1, 1, 10, 980.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti, Periyakulam TK, Theni DT', 'Leave at door inside', 0.00, 0.00, NULL, '2026-07-18 07:47:59', '2026-07-25 06:43:30'),
(11, 1, 1, 11, 1225.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-07-18 16:15:00', '2026-08-09 09:34:54'),
(12, 1, 1, 12, 490.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-07-18 16:37:55', '2026-07-25 06:42:55'),
(13, 1, 1, 13, 490.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-07-23 06:04:32', '2026-08-09 09:34:59'),
(14, 1, 1, 14, 245.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-07-23 06:11:21', '2026-08-09 09:35:04'),
(15, 1, 1, 15, 8505.00, 'delivered', 'online', 'paid', 'order_THchEcunWwLTj1', 'pay_THchPMwzlIcz5C', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-07-25 05:40:02', '2026-08-09 09:34:48'),
(16, 1, 1, 16, 440.00, 'delivered', 'online', 'paid', 'order_THdi0ybZZTzftU', 'pay_THdi8rgqjH7Shg', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-07-25 06:39:20', '2026-07-25 06:42:40'),
(17, 1, 1, 17, 3965.00, 'delivered', 'online', 'paid', 'order_THe3k2VMrSWt4k', 'pay_THe3w8gNVNKKM7', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-07-25 06:59:56', '2026-08-09 09:34:43'),
(18, 1, 2, 18, 2525.00, 'delivered', 'online', 'paid', 'order_TIOlO6ZldHpQFS', 'pay_TIOlaM5uwU0lsU', 'Ooty', '', 0.00, 0.00, NULL, '2026-07-27 04:41:09', '2026-07-27 04:42:24'),
(22, 1, 1, 19, 1300.00, 'delivered', 'online', 'paid', 'order_TLEXQ5q1xL1OJM', 'pay_TLEXnG8jLGmUd3', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-03 08:38:10', '2026-08-09 09:34:36'),
(23, 1, 1, 20, 1320.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-06 17:54:57', '2026-08-09 09:34:30'),
(24, 1, 1, 21, 580.00, 'delivered', 'online', 'paid', 'order_TMlcFJY8nP149V', 'pay_TMle9Yk7uXQwLo', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-07 05:40:17', '2026-08-09 09:34:26'),
(25, 1, 1, 22, 1190.00, 'delivered', 'online', 'paid', 'order_TMm5mIFZHEYnWB', 'pay_TMm5v9lvQKsdjK', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-07 06:06:20', '2026-08-07 06:08:42'),
(26, 1, 1, 23, 8775.00, 'delivered', 'online', 'paid', 'order_TNceuDbDNp5gsz', 'pay_TNcfAO74KudhR6', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-09 09:32:01', '2026-08-09 09:34:22'),
(27, 9, 3, 1, 45000.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-08-09 10:20:08', '2026-08-09 10:29:07'),
(28, 1, 1, 24, 821.51, 'delivered', 'online', 'paid', 'order_TNdc0CKEymZnlH', 'pay_TNdc6jDNm7zv6C', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-09 10:27:34', '2026-08-12 08:03:23'),
(29, 9, 3, 2, 4500.00, 'pending', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-08-09 10:30:03', '2026-08-09 10:30:03'),
(30, 1, 1, 25, 21776.51, 'delivered', 'online', 'paid', 'order_TOjqruzSE6RdOy', 'pay_TOjr0pIxDnA2vN', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-12 05:13:06', '2026-08-12 07:56:40'),
(31, 1, 1, 26, 6213.02, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-12 07:58:40', '2026-08-12 08:03:17'),
(32, 1, 4, 27, 3036.51, 'delivered', 'online', 'paid', 'order_TOpeYLXvgQSdXq', 'pay_TOpf8N785Cip6D', 'Pochampalli, Krishnagiri', '', 0.00, 0.00, NULL, '2026-08-12 10:53:47', '2026-08-14 10:22:13'),
(33, 1, 1, 28, 60.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-14 09:36:44', '2026-08-14 09:42:23'),
(34, 1, 1, 29, 539740.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-14 09:41:14', '2026-09-17 05:32:07'),
(35, 1, 1, 30, 30000.00, 'delivered', 'online', 'paid', 'order_TPbY9p2SjRscsS', 'pay_TPbYpwF6qfBXsg', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-14 09:45:08', '2026-08-14 09:53:19'),
(36, 1, 1, 31, 40.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-14 09:52:48', '2026-08-14 09:53:25'),
(37, 1, 7, 32, 160.00, 'delivered', 'online', 'paid', 'order_TQoGySI6SJOrgn', 'pay_TQoH7nFYgpHlE7', 'Iduvampalayam, Sultanpet', '', 0.00, 0.00, NULL, '2026-08-17 10:50:22', '2026-08-21 06:26:19'),
(38, 1, 7, 33, 20.00, 'delivered', 'cod', 'pending', NULL, NULL, 'Theni', '', 0.00, 0.00, NULL, '2026-08-17 10:56:29', '2026-08-21 06:26:16'),
(39, 1, 8, 34, 520.00, 'delivered', 'online', 'paid', 'order_TS276fVE84bQUt', 'pay_TS27XNouM4OGfi', 'Theni', '', 0.00, 0.00, NULL, '2026-08-20 13:02:00', '2026-08-21 06:27:14'),
(40, 1, 1, 35, 3121.51, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-21 06:33:46', '2026-09-17 05:38:52'),
(41, 1, 1, 36, 2120.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-21 07:32:00', '2026-08-23 12:14:34'),
(42, 1, 1, 37, 3955.00, 'delivered', 'online', 'paid', 'order_TSmbi9HcjRVm3a', 'pay_TSmbrty9F1AmdE', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-22 10:30:35', '2026-08-23 12:14:44'),
(43, 1, 1, 38, 6000.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-08-23 12:11:54', '2026-08-23 12:14:49'),
(44, 1, 1, 39, 559.00, 'delivered', 'online', 'paid', 'order_TWnLkk5nlhhyj4', 'pay_TWnLod9zalPuNi', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-09-01 13:50:06', '2026-09-17 05:37:47'),
(45, 1, 1, 40, 1171.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-09-16 18:55:18', '2026-09-17 05:35:25'),
(46, 1, 1, 41, 179.00, 'delivered', 'cod', 'pending', NULL, NULL, '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-09-17 05:21:09', '2026-09-17 05:36:34'),
(47, 1, 1, 42, 250.00, 'delivered', 'online', 'paid', 'order_TdyZhVaETPt9Jd', 'pay_TdyaWShlhvjWJd', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-09-19 17:22:40', '2026-09-19 17:25:00'),
(48, 1, 1, 43, 225.00, 'delivered', 'online', 'paid', 'order_TdzBZszReMNqfT', 'pay_TdzBxZTL8PNJOZ', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-09-19 17:58:11', '2026-09-19 18:29:10'),
(49, 1, 1, 44, 250.00, 'delivered', 'online', 'paid', 'order_Tdzddh9g0P3PyT', 'pay_Tdze6KMXmV2lgT', '5-2-49, Vaniyar Street, Vadugapatti', '', 0.00, 0.00, NULL, '2026-09-19 18:25:00', '2026-09-19 18:29:50');
...
(65, 1, 7, 'Fabelle Milk Gianduja (100g)', 'Premium milk chocolate with smooth nutty gianduja filling.', 255.00, 250.00, NULL, 'https://assets.telegraphindia.com/telegraph/2021/Jul/1625601988_gianduja-milk.jpg', NULL, NULL, 13, 1, 1, '2026-08-22 12:38:32'),
...
(68, 1, 9, 'Happilo Premium Arabian Dates (500g)', 'Soft Arabian dates for snacking and desserts.', 240.00, 225.00, NULL, 'https://veehafoods.com/cdn/shop/files/01_a5715427-bdd9-4955-b1dc-62bb878f0d2c.jpg?crop=center&height=2000&v=1734170664&width=2000', NULL, NULL, 33, 5, 1, '2026-08-22 12:38:32'),
...
(74, 1, 5, 'Aavin Ghee (500ml)', 'Tamil Nadu dairy ghee with rich traditional aroma.', 395.00, 380.00, NULL, 'https://platinum-24bucket.s3.ap-southeast-1.amazonaws.com/kkshoppy/2024/01/MBOxB09309.jpeg', NULL, NULL, 38, 11, 1, '2026-08-22 12:38:32'),
(75, 1, 5, 'Arokya Ghee (500ml)', 'Pure dairy ghee suitable for sweets, pongal and everyday cooking.', 410.00, 395.00, NULL, 'https://cdn2.clevup.in/340140/HATSUN-GHEE-3d-Pack_1366-768---500ml-1716038850299.jpeg?format=webp&width=600', NULL, NULL, 31, 12, 1, '2026-08-22 12:38:32'),
...
--
-- Table structure for table `shop_handlers`
--

CREATE TABLE `shop_handlers` (
  `id` int(10) UNSIGNED NOT NULL,
  `shop_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(120) NOT NULL,
  `email` varchar(180) NOT NULL,
...
--
-- Dumping data for table `shop_handlers`
--

INSERT INTO `shop_handlers` (`id`, `shop_id`, `name`, `email`, `password`, `phone`, `is_active`, `cod_wallet`, `created_at`) VALUES
(1, 1, 'Siva Balaji', 'sivabalaji800@gmail.com', '$2y$10$BOVwltzGxHugsEFLZHDbtutE2fx104/TOId0XWCtUrWrErHBvD1Ha', '7904538655', 1, 0.00, '2026-09-16 18:48:57');
...
(6, 10, 1, 'grace', '2026-08-21 07:30:46', '2026-09-20 07:30:46', '2026-09-27 07:30:46', NULL, NULL, NULL, NULL, '2026-08-21 07:30:46', '2026-08-23 11:56:18'),
...
(9, 1, 3, 'completed', '2026-08-22 00:00:00', '2026-09-21 00:00:00', '2026-09-28 00:00:00', '120716977953', '', 1, '2026-08-22 10:53:50', '2026-08-22 10:53:50', '2026-08-23 12:12:39'),
(10, 1, 2, 'completed', '2026-08-23 00:00:00', '2026-09-22 00:00:00', '2026-09-29 00:00:00', '', '', 1, '2026-08-23 12:12:39', '2026-08-23 12:12:39', '2026-08-23 12:13:52'),
(11, 1, 2, 'completed', '2026-08-23 00:00:00', '2026-09-22 00:00:00', '2026-09-29 00:00:00', '', '', 1, '2026-08-23 12:13:52', '2026-08-23 12:13:52', '2026-08-23 12:13:56'),
(12, 1, 2, 'active', '2026-08-23 00:00:00', '2026-10-22 00:00:00', '2026-10-29 00:00:00', '', '', 1, '2026-09-12 10:29:24', '2026-08-23 12:13:56', '2026-09-12 10:29:24');

-- --------------------------------------------------------

--
-- Table structure for table `superadmin_audit_logs`
--
...
--
-- Dumping data for table `superadmin_audit_logs`
--

INSERT INTO `superadmin_audit_logs` (`id`, `occurred_at`, `admin_id`, `admin_name`, `admin_email`, `action`, `entity_type`, `entity_id`, `entity_label`, `shop_id`, `shop_name`, `summary`, `before_data`, `after_data`, `ip_address`, `source_page`) VALUES
(1, '2026-09-12 10:28:56.426289', 1, 'Super Admin', 'admin@tamizhmart.com', 'shops.suspend', 'shop', 10, 'Baskaran Bakery', 10, 'Baskaran Bakery', 'Shop suspended: Baskaran Bakery', '{\"id\":10,\"name\":\"Baskaran Bakery\",\"slug\":\"baskaran-bakery\",\"owner_id\":9,\"is_active\":1,\"is_suspended\":0}', '{\"id\":10,\"name\":\"Baskaran Bakery\",\"slug\":\"baskaran-bakery\",\"owner_id\":9,\"is_active\":0,\"is_suspended\":1}', '172.18.0.1', 'shops.php'),
(2, '2026-09-12 10:28:57.914443', 1, 'Super Admin', 'admin@tamizhmart.com', 'shops.activate', 'shop', 10, 'Baskaran Bakery', 10, 'Baskaran Bakery', 'Shop restored: Baskaran Bakery', '{\"id\":10,\"name\":\"Baskaran Bakery\",\"slug\":\"baskaran-bakery\",\"owner_id\":9,\"is_active\":0,\"is_suspended\":1}', '{\"id\":10,\"name\":\"Baskaran Bakery\",\"slug\":\"baskaran-bakery\",\"owner_id\":9,\"is_active\":1,\"is_suspended\":0}', '172.18.0.1', 'shops.php'),
(3, '2026-09-12 10:29:24.831637', 1, 'Super Admin', 'admin@tamizhmart.com', 'subscriptions.extend', 'subscription', 12, 'SM Stores', 1, 'SM Stores', 'Subscription extended: SM Stores', '{\"shop\":{\"id\":1,\"name\":\"SM Stores\",\"is_active\":1,\"is_suspended\":0},\"subscriptions\":{\"1\":{\"id\":1,\"plan_id\":1,\"status\":\"completed\",\"started_at\":\"2026-08-21 07:30:46\",\"expires_at\":\"2026-10-20 07:30:46\",\"grace_until\":\"2026-10-27 07:30:46\",\"payment_ref\":null,\"activated_by\":1},\"8\":{\"id\":8,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-21 00:00:00\",\"expires_at\":\"2026-10-20 00:00:00\",\"grace_until\":\"2026-10-27 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"9\":{\"id\":9,\"plan_id\":3,\"status\":\"completed\",\"started_at\":\"2026-08-22 00:00:00\",\"expires_at\":\"2026-09-21 00:00:00\",\"grace_until\":\"2026-09-28 00:00:00\",\"payment_ref\":\"120716977953\",\"activated_by\":1},\"10\":{\"id\":10,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"11\":{\"id\":11,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"12\":{\"id\":12,\"plan_id\":2,\"status\":\"active\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1}},\"collections\":{\"1\":{\"id\":1,\"subscription_id\":8,\"total_revenue\":\"2120.00\",\"order_count\":1,\"commission_amount\":\"42.40\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"2\":{\"id\":2,\"subscription_id\":8,\"total_revenue\":\"3955.00\",\"order_count\":1,\"commission_amount\":\"79.10\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"3\":{\"id\":3,\"subscription_id\":10,\"total_revenue\":\"6000.00\",\"order_count\":1,\"commission_amount\":\"120.00\",\"commission_rate\":\"2.00\",\"collected_by\":1}}}', '{\"shop\":{\"id\":1,\"name\":\"SM Stores\",\"is_active\":1,\"is_suspended\":0},\"subscriptions\":{\"1\":{\"id\":1,\"plan_id\":1,\"status\":\"completed\",\"started_at\":\"2026-08-21 07:30:46\",\"expires_at\":\"2026-10-20 07:30:46\",\"grace_until\":\"2026-10-27 07:30:46\",\"payment_ref\":null,\"activated_by\":1},\"8\":{\"id\":8,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-21 00:00:00\",\"expires_at\":\"2026-10-20 00:00:00\",\"grace_until\":\"2026-10-27 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"9\":{\"id\":9,\"plan_id\":3,\"status\":\"completed\",\"started_at\":\"2026-08-22 00:00:00\",\"expires_at\":\"2026-09-21 00:00:00\",\"grace_until\":\"2026-09-28 00:00:00\",\"payment_ref\":\"120716977953\",\"activated_by\":1},\"10\":{\"id\":10,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"11\":{\"id\":11,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"12\":{\"id\":12,\"plan_id\":2,\"status\":\"active\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-10-22 00:00:00\",\"grace_until\":\"2026-10-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1}},\"collections\":{\"1\":{\"id\":1,\"subscription_id\":8,\"total_revenue\":\"2120.00\",\"order_count\":1,\"commission_amount\":\"42.40\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"2\":{\"id\":2,\"subscription_id\":8,\"total_revenue\":\"3955.00\",\"order_count\":1,\"commission_amount\":\"79.10\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"3\":{\"id\":3,\"subscription_id\":10,\"total_revenue\":\"6000.00\",\"order_count\":1,\"commission_amount\":\"120.00\",\"commission_rate\":\"2.00\",\"collected_by\":1}}}', '172.18.0.1', 'subscriptions.php'),
(4, '2026-09-12 10:30:10.597947', 1, 'Super Admin', 'admin@tamizhmart.com', 'subscriptions.collect_commission', 'subscription', 12, 'SM Stores', 1, 'SM Stores', 'Commission collected: SM Stores', '{\"shop\":{\"id\":1,\"name\":\"SM Stores\",\"is_active\":1,\"is_suspended\":0},\"subscriptions\":{\"1\":{\"id\":1,\"plan_id\":1,\"status\":\"completed\",\"started_at\":\"2026-08-21 07:30:46\",\"expires_at\":\"2026-10-20 07:30:46\",\"grace_until\":\"2026-10-27 07:30:46\",\"payment_ref\":null,\"activated_by\":1},\"8\":{\"id\":8,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-21 00:00:00\",\"expires_at\":\"2026-10-20 00:00:00\",\"grace_until\":\"2026-10-27 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"9\":{\"id\":9,\"plan_id\":3,\"status\":\"completed\",\"started_at\":\"2026-08-22 00:00:00\",\"expires_at\":\"2026-09-21 00:00:00\",\"grace_until\":\"2026-09-28 00:00:00\",\"payment_ref\":\"120716977953\",\"activated_by\":1},\"10\":{\"id\":10,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"11\":{\"id\":11,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"12\":{\"id\":12,\"plan_id\":2,\"status\":\"active\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-10-22 00:00:00\",\"grace_until\":\"2026-10-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1}},\"collections\":{\"1\":{\"id\":1,\"subscription_id\":8,\"total_revenue\":\"2120.00\",\"order_count\":1,\"commission_amount\":\"42.40\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"2\":{\"id\":2,\"subscription_id\":8,\"total_revenue\":\"3955.00\",\"order_count\":1,\"commission_amount\":\"79.10\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"3\":{\"id\":3,\"subscription_id\":10,\"total_revenue\":\"6000.00\",\"order_count\":1,\"commission_amount\":\"120.00\",\"commission_rate\":\"2.00\",\"collected_by\":1}}}', '{\"shop\":{\"id\":1,\"name\":\"SM Stores\",\"is_active\":1,\"is_suspended\":0},\"subscriptions\":{\"1\":{\"id\":1,\"plan_id\":1,\"status\":\"completed\",\"started_at\":\"2026-08-21 07:30:46\",\"expires_at\":\"2026-10-20 07:30:46\",\"grace_until\":\"2026-10-27 07:30:46\",\"payment_ref\":null,\"activated_by\":1},\"8\":{\"id\":8,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-21 00:00:00\",\"expires_at\":\"2026-10-20 00:00:00\",\"grace_until\":\"2026-10-27 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"9\":{\"id\":9,\"plan_id\":3,\"status\":\"completed\",\"started_at\":\"2026-08-22 00:00:00\",\"expires_at\":\"2026-09-21 00:00:00\",\"grace_until\":\"2026-09-28 00:00:00\",\"payment_ref\":\"120716977953\",\"activated_by\":1},\"10\":{\"id\":10,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"11\":{\"id\":11,\"plan_id\":2,\"status\":\"completed\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-09-22 00:00:00\",\"grace_until\":\"2026-09-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1},\"12\":{\"id\":12,\"plan_id\":2,\"status\":\"active\",\"started_at\":\"2026-08-23 00:00:00\",\"expires_at\":\"2026-10-22 00:00:00\",\"grace_until\":\"2026-10-29 00:00:00\",\"payment_ref\":\"\",\"activated_by\":1}},\"collections\":{\"1\":{\"id\":1,\"subscription_id\":8,\"total_revenue\":\"2120.00\",\"order_count\":1,\"commission_amount\":\"42.40\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"2\":{\"id\":2,\"subscription_id\":8,\"total_revenue\":\"3955.00\",\"order_count\":1,\"commission_amount\":\"79.10\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"3\":{\"id\":3,\"subscription_id\":10,\"total_revenue\":\"6000.00\",\"order_count\":1,\"commission_amount\":\"120.00\",\"commission_rate\":\"2.00\",\"collected_by\":1},\"4\":{\"id\":4,\"subscription_id\":12,\"total_revenue\":\"559.00\",\"order_count\":1,\"commission_amount\":\"11.18\",\"commission_rate\":\"2.00\",\"collected_by\":1}}}', '172.18.0.1', 'subscriptions.php'),
(5, '2026-09-17 05:10:10.319875', 1, 'Super Admin', 'admin@tamizhmart.com', 'auth.login', 'administrator', 1, 'Administrator account', NULL, NULL, 'Admin signed in', '[]', '[]', '172.18.0.1', 'login.php');

-- --------------------------------------------------------

--
-- Table structure for table `superadmin_audit_shops`
--

CREATE TABLE `superadmin_audit_shops` (
...
--
-- Dumping data for table `superadmin_audit_shops`
--

INSERT INTO `superadmin_audit_shops` (`audit_id`, `shop_id`, `shop_name`) VALUES
(1, 10, 'Baskaran Bakery'),
(2, 10, 'Baskaran Bakery'),
(3, 1, 'SM Stores'),
(4, 1, 'SM Stores');
...
(7, 1, 'Siva Balaji', 'sivabalaji2335@gmail.com', '$2y$10$bP7IVOawUmyRfd5rNUaotOnwx4y0/1d2dEcS.AzNQFSSe39WjxH9G', '7904538655', '', 1, '2026-08-15 16:53:38', '106486502399939543042', 'google'),
(8, 1, 'Siva Balaji', 'sivathetechie24@gmail.com', NULL, '7904538655', 'Theni', 1, '2026-08-18 15:56:28', '112586899433367938013', 'google'),
(9, 1, 'Siva Balaji', 'sivabalaji607@gmail.com', '$2y$10$JVzAHL7Up/JX37NuVKQ6h.ug17Jd95rlTpfFAzGsUzj1E9ieciMAa', '7904538655', 'theni', 1, '2026-09-05 18:32:09', NULL, 'local'),
(10, 1, 'Siva Balaji', 'sivabalaji709@gmail.com', '$2y$10$6jxMObBuP4fLuOdd43AymupEFhpIV2WjIku60tkt/OFrtELmzb8Da', '7904538655', 'Madurai', 1, '2026-09-05 18:32:35', NULL, 'local'),
(11, 1, 'Siva Balaji', 'sivabalaji381@gmail.com', '$2y$10$C/lssXrClRR1ZLnNHJczI.5ON6xU2bYI41jHS5//m2hDWFfj.6Dfi', '7904538644', 'Tiruppur', 1, '2026-09-05 18:33:14', NULL, 'local'),
(12, 1, 'Tamizhmart', 'tamizhmartnotify@gmail.com', '$2y$10$.VX42Oy/TDFvZEbRyPRzbezpbgIOTtxhkAInb.kR5x9ut9La0SUUm', '7904538655', 'Coimbatore', 1, '2026-09-05 18:33:47', NULL, 'local');
...
ALTER TABLE `coupons`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `shop_code` (`shop_id`,`code`),
  ADD KEY `idx_shop` (`shop_id`);
...
ALTER TABLE `delivery_otps`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_dotp_order` (`order_id`);
...
ALTER TABLE `email_campaigns`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_shop_month` (`shop_id`,`month_key`),
  ADD KEY `idx_shop_status` (`shop_id`,`status`);

--
-- Indexes for table `email_campaign_allowances`
--
ALTER TABLE `email_campaign_allowances`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_shop_month` (`shop_id`,`month_key`),
  ADD KEY `idx_month_key` (`month_key`);

--
-- Indexes for table `email_campaign_products`
--
ALTER TABLE `email_campaign_products`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `handler_activity_log`
--
ALTER TABLE `handler_activity_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_hal_handler` (`handler_id`),
  ADD KEY `idx_hal_order` (`order_id`);

--
-- Indexes for table `handler_cod_settlements`
--
ALTER TABLE `handler_cod_settlements`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_hcs_handler` (`handler_id`);
...
--
-- Indexes for table `shop_handlers`
--
ALTER TABLE `shop_handlers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_handler_email` (`email`),
  ADD KEY `idx_handler_shop` (`shop_id`);
...
--
-- Indexes for table `superadmin_audit_logs`
--
ALTER TABLE `superadmin_audit_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_audit_time` (`occurred_at`,`id`),
  ADD KEY `idx_audit_admin` (`admin_id`,`occurred_at`),
  ADD KEY `idx_audit_action` (`action`,`occurred_at`),
  ADD KEY `idx_audit_shop` (`shop_id`,`occurred_at`),
  ADD KEY `idx_audit_entity` (`entity_type`,`entity_id`);

--
-- Indexes for table `superadmin_audit_shops`
--
ALTER TABLE `superadmin_audit_shops`
  ADD PRIMARY KEY (`audit_id`,`shop_id`),
  ADD KEY `idx_audit_affected_shop` (`shop_id`,`audit_id`);
...
--
-- AUTO_INCREMENT for table `email_campaign_allowances`
--
ALTER TABLE `email_campaign_allowances`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=266;

--
-- AUTO_INCREMENT for table `email_campaign_products`
--
ALTER TABLE `email_campaign_products`
...
--
-- AUTO_INCREMENT for table `handler_activity_log`
--
ALTER TABLE `handler_activity_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `handler_cod_settlements`
--
ALTER TABLE `handler_cod_settlements`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `shop_handlers`
--
ALTER TABLE `shop_handlers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `superadmin_audit_logs`
--
ALTER TABLE `superadmin_audit_logs`
...
--
-- Constraints for table `superadmin_audit_shops`
--
ALTER TABLE `superadmin_audit_shops`
  ADD CONSTRAINT `fk_audit_shop_event` FOREIGN KEY (`audit_id`) REFERENCES `superadmin_audit_logs` (`id`) ON DELETE CASCADE;
